...
const TEMPLATE_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "UI/UX Design",
        description: "Figma mockups and prototyping",
        quantity: 20,
        unitPrice: cents(120),
      },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Code Review & Audit", quantity: 16, unitPrice: cents(130) },
      {
        ...
        description: "Security report and recommendations",
        quantity: 4,
        unitPrice: cents(90),
      },
      ...
      for (const spec of INVOICE_SPECS) {
        ...
        const invoice = await tx.invoice.create({
          data: {
            ...
            paidAt,
            paymentMethod,
            notes: isDraft ? "Draft — review before sending." : null,
            tags: spec.taxRate > 0 ? ["taxable"] : [],
            paymentReference: isDraft ? null : `INV${nanoid(6).toUpperCase()}`,
            createdAt,
            updatedAt: createdAt,
            items: { create: items },
          },
